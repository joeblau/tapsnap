...
internal enum L10n {
    ...
    /// You are currently not connected to the internet, please connect to cellular or wifi.
    ...
    internal static func keyByteCount(_ p1: Int) -> String {
        L10n.tr("Localizable", "key_byte_count", p1)
    }

    /// Photo from %@
    internal static func photoFrom(_ p1: String) -> String {
        L10n.tr("Localizable", "photo_from", p1)
    }
    ...
    internal static func videoFrom(_ p1: String) -> String {
        L10n.tr("Localizable", "video_from", p1)
    }
}
